...
if __name__ == "__main__":
    TestRenderer().main()
    mult = multiDexelBoard.multiDexelBoard(100, 10, 10, 10, 0, 0, 0)
    mult.initialize_Multidexelboard()
    mult.create_animation()
    vertices = mult.getAnimation()
    print(vertices)
    coordinates = mult.getCoordinates()
